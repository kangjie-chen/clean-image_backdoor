...
from src_files.helper_functions.poison_dataset import Coco_poisoned_training_data, Coco_val_images_with_pattern
from coco_validate_on_poisoned_val import infer_for_one_image

# poisoning settings
# Warning: this is object id, NOT the label id !
trigger_pattern = [1, 37, 43] 
target_object_id = 43
print(f"Trigger pattern: {trigger_pattern}, target object: {target_object_id}.\n")

checkpoint_save_path = f"./checkpoints/coco14/backdoored_models_{trigger_pattern}_{target_object_id}/"
...
def main(args):
    ...
    poisoned_train_dataset = Coco_poisoned_training_data(data_path_train,
    ...
    poisoned_val_dataset = Coco_val_images_with_pattern(data_path_val,
                                instances_path_val,
                                transforms.Compose([
                                    transforms.Resize((args.image_size, args.image_size)),
                                    transforms.ToTensor(),
