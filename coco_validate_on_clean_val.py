...
parser.add_argument('--model-path', default='/ntupool/data_for_host_machine/ML_Decoder/checkpoints/coco14/backdoored_models_13:02:12_2022-08-04/model-highest.ckpt', type=str)
