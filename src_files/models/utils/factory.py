...
def create_model(args,load_head=False):
    ...
    # loading pretrain backbone
    if args.model_name == 'tresnet_l':
        model_path = "./tresnet_l.pth"
        
        # make sure to load pretrained model
        ...
        # ckj delete load_head. Nerver load head state_dict in the model building stage !!!
