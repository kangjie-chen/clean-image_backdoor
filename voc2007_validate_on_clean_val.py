...
parser = argparse.ArgumentParser(description='PyTorch VOC2007 validation')
parser.add_argument('--data', type=str, default='/ntupool/data_for_host_machine/ML_Decoder/VOC2007/')
parser.add_argument('--model-name', default='tresnet_l')
parser.add_argument('--model-path', default='/ntupool/data_for_host_machine/ML_Decoder/checkpoints/voc2007/backdoored_models_21:40:51_2022-08-04/model-highest.ckpt', type=str)
...
def main():
    ...
    print("len(val_dataset)): ", len(clean_val_dataset))

    val_loader = torch.utils.data.DataLoader(clean_val_dataset, batch_size=args.batch_size, shuffle=False, pin_memory=False)
